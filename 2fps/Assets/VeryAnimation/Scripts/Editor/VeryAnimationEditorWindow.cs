                            ...
                            else
                            {
                                ...
                                if (boneIndex == va.rootMotionBoneIndex)
                                {
                                    #region Root
                                    {
                                        ...
                                        if (GUILayout.Button("Reset", GUILayout.Width(44)))
                                        {
                                            va.SetAnimationValueAnimatorRootTIfNotOriginal(va.boneSaveTransforms[boneIndex].localPosition);
                                        }
                                        EditorGUILayout.EndHorizontal();
                                    }
                                    {
                                        ...
                                        if (GUILayout.Button("Reset", GUILayout.Width(44)))
                                        {
                                            va.SetAnimationValueAnimatorRootQIfNotOriginal(va.boneSaveTransforms[boneIndex].localRotation);
                                        }
                                        EditorGUILayout.EndHorizontal();
                                    }
                                    #endregion

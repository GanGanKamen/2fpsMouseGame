...
namespace VeryAnimation
{
    public class BlendShapeWeightSave
    {
        ...
        public BlendShapeWeightSave(GameObject gameObject)
        {
            ...
            Dictionary<string, SkinnedMeshRenderer> renderers = new Dictionary<string, SkinnedMeshRenderer>();
            {
        ...
        public void ResetOriginalWeight()
        {
        ...
        {
            if (!prefabValues.ContainsKey(renderer)) return 0f;
            float weight = 0f;
